...
export const messages = {
  id: {
    ...
    ride: {
      ...
      stop: 'Hentikan',
      stopConfirm: 'Hentikan perjalanan?',
      enableFlag: 'Aktifkan mode pendamping (beta)',
      activeBadge: 'Pendamping aktif',
      stepOf: 'Langkah {current} dari {total}',
      hud: {
        walking: 'Jalan ke {target}',
        waiting: 'Tunggu bus {kor}',
        onBus: 'Di bus, turun di {target}',
        transferring: 'Pindah {from} → {to}',
        arrived: 'Tiba di {destination}',
        toGo: '{m} m lagi',
        eta: '~{min} menit',
        boarded: 'Saya sudah naik bus',
        alighted: 'Saya turun di sini',
        share: 'Bagikan',
        done: 'Selesai',
      ...
      cues: {
        ...
        boardingNear: 'Halte {halte} di depan. Bus {kor} akan tiba sekitar {min} menit.',
        boardingNearNoEta: 'Halte {halte} di depan. Tunggu bus {kor}.',
        etaUpdate: 'Bus {kor} sekitar {min} menit lagi.',
        boarded: 'Naik bus {kor}. Halte berikutnya: {next}.',
        transferNear: 'Siap turun di halte {halte}. Pindah ke koridor {next}.',
  ...
  en: {
    ...
    ride: {
      start: 'Start Trip',
      stop: 'Stop',
      stopConfirm: 'Stop the trip?',
      enableFlag: 'Enable trip companion (beta)',
      activeBadge: 'Companion active',
      stepOf: 'Step {current} of {total}',
      hud: {
        walking: 'Walk to {target}',
        waiting: 'Wait for bus {kor}',
        onBus: 'On bus, alight at {target}',
        transferring: 'Transfer {from} → {to}',
        arrived: 'Arrived at {destination}',
        toGo: '{m} m to go',
        eta: '~{min} min',
        boarded: 'I am on the bus',
        alighted: 'I am getting off',
        share: 'Share',
        done: 'Done',
      ...
      cues: {
        ...
        boardingNear: '{halte} is ahead. Bus {kor} arrives in about {min} minutes.',
        boardingNearNoEta: '{halte} is ahead. Wait for bus {kor}.',
        etaUpdate: 'Bus {kor} in about {min} minutes.',
        boarded: 'On bus {kor}. Next stop: {next}.',
